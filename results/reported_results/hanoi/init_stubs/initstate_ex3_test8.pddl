(:init
    ...
    (on colored_disk5 colored_disk6)
    (on colored_disk5 colored_disk8)
    (on colored_disk7 colored_disk)
    (on colored_disk7 colored_disk1)
    (on colored_disk7 colored_disk2)
    (on colored_disk7 colored_disk3)
    (on colored_disk7 colored_disk4)
    (on colored_disk7 colored_disk5)
    (on colored_disk7 colored_disk6)
    (on colored_disk7 colored_disk8)
    (on colored_disk8 colored_disk)
    (on colored_disk8 colored_disk1)
    (on colored_disk8 colored_disk2)
    (on colored_disk8 colored_disk3)
    (on colored_disk8 colored_disk4)
    (on colored_disk8 colored_disk6)
    (on colored_disk9 colored_disk)
    (on colored_disk9 colored_disk1)
    (on colored_disk9 colored_disk2)
    (on colored_disk9 colored_disk3)
    (on colored_disk9 colored_disk4)
    (on colored_disk9 colored_disk5)
    (on colored_disk9 colored_disk6)
    (on colored_disk9 colored_disk7)
    (on colored_disk9 colored_disk8)
